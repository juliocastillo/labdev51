...
The <info>app:user:create</info> command creates a user:
  <info>php bin/console app:user:create matthieu@example.com</info>
...
You can create a super admin via the super-admin flag:
  <info>php bin/console app:user:create matthieu@example.com mypassword ROLE_SUPER_ADMIN</info>
EOT;
    }
}
