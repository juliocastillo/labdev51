...
/*
 *  CONCAT_WS
 *      Concatena todos los elementos proporcionados exceptuando el primero.
 *      el primer elemento es utilizado como separador, los elementos nulos
 *      son ignorados
 *
 *  DBMS Soportados | Documentación
 *  ----------------+-----------------------------------------------------------
 *      PostgreSql  |   http://www.postgresql.org/docs/9.1/static/functions-string.html
 *      Oracle      |   https://docs.oracle.com/cd/E17952_01/refman-5.1-en/string-functions.html#function_concat-ws
 *      MySql       |   http://dev.mysql.com/doc/refman/5.7/en/string-functions.html#function_concat-ws
 *
 *  ConcatWsFunction ::= "CONCAT_WS" "(" ArithmeticPrimary "," ArithmeticPrimary "," ... "," ArithmeticPrimary(n) ")"
 */
namespace App\Dql;
